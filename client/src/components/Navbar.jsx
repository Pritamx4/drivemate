...
import { Car, Menu, X, LogIn, Phone } from 'lucide-react';
...
export default function Navbar() {
  ...
  // Close menu on navigation or larger screens
  useEffect(() => {
    setMenuOpen(false);
  }, [location.pathname]);
